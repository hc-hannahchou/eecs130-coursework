...
const next = () => {
  ...
  if (clickedElement.parentElement.nextElementSibling === null){
    console.log('the end');
    clickedElement = document.querySelectorAll('.image')[0];
    console.log(clickedElement);
  } else{
    clickedElement = clickedElement.parentElement.nextElementSibling.firstElementChild;
  }

  document.querySelector('.featured_image').style.backgroundImage = clickedElement.style.backgroundImage;
...
const previous = () => {
  if (clickedElement.parentElement.previousElementSibling === null ){
    const numImages = document.querySelectorAll('.image').length;
    clickedElement = document.querySelectorAll('.image')[numImages-1];
    console.log('the beg');
  }
  else{
    clickedElement = clickedElement.parentElement.previousElementSibling.firstElementChild;
  }
